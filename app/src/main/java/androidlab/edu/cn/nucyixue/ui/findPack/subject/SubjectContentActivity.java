...
public class SubjectContentActivity extends BaseActivity {
    ...
    protected void logicActivity(Bundle mSavedInstanceState) {
        ...
        mSubjectContentToolbar.setTitle(mBundle.getString("subjectName"));
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.content_xuanshang:
                ActivityUtils.replaceFragmentToActivity(mFragmentManager,SubjectXuanshangFragment.getInstance(),R.id.content_xuanshang);
                break;
        }
    }
}
