...
class LCIMConversationItem implements Comparable {
    private static final String ITEM_KEY_CONVERSATION_ID = "conversation_id";
    ...
    public String toJsonString() {
        ...
        jsonObject.put(ITEM_KEY_CONVERSATION_ID, conversationId);
    ...
    public static LCIMConversationItem fromJsonString(String json) {
        ...
        try {
            ...
            item.conversationId = jsonObject.getString(ITEM_KEY_CONVERSATION_ID);
