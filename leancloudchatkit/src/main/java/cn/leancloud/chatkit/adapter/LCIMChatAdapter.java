...
import cn.leancloud.chatkit.viewholder.LCIMChatItemFileHolder;
...
public class LCIMChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final int ITEM_LEFT_FILE = 105;
    ...
    private final int ITEM_RIGHT_FILE = 205;
    ...
    public LCIMChatAdapter(String speakerId) {
        super();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case ITEM_LEFT_FILE:
                return new LCIMChatItemFileHolder(parent.getContext(), parent, true);
            case ITEM_RIGHT:
            ...
            case ITEM_RIGHT_FILE:
                return new LCIMChatItemFileHolder(parent.getContext(), parent, false);
            default:
                return new LCIMChatItemTextHolder(parent.getContext(), parent, true);
        }
    }
        ...
        if (null != message && message instanceof AVIMTypedMessage) {
            ...
            if (typedMessage.getMessageType() == AVIMReservedMessageType.TextMessageType.getType()) {
                ...
                if(textMessage.getAttrs() == null){
                    ...
                    return isMe ? ITEM_RIGHT_FILE : ITEM_LEFT_FILE;
                }
    ...
    public void resetRecycledViewPoolSize(RecyclerView recyclerView) {
        ...
        recyclerView.getRecycledViewPool().setMaxRecycledViews(ITEM_LEFT_FILE, 10);
        ...
        recyclerView.getRecycledViewPool().setMaxRecycledViews(ITEM_RIGHT_FILE, 10);
    }
    ...
    protected boolean fromMe(AVIMTypedMessage msg) {
        ...
        if(speakerId == null){
            ...
            AVQuery<AVObject> query = new AVQuery<>("Live");
            query.whereEqualTo("conversationId", AVObject.createWithoutData("_Conversation", conversationId));
        ...
        Log.i("tag", speakerId +" " + msg.getFrom());
        return !msg.getFrom().equals(speakerId);
    }
}